  ...
  >
    ...
    >
      ...
      <div v-if="!menuOpen" @click="demo_click" class="imgMore">
        <img
          class="more-img"
          src="https://scpic.chinaz.net/Files/pic/pic9/202004/zzpic24249_s.jpg"
          alt=""
          title="多功能菜单"
        />
      </div>
...
export default {
  ...
  methods: {
    ...
    //    鼠标抬起
    demo_up(event) {
      console.log("demo_up", event,event);
      //  当前页面全局容器 dom 元素  获取容器 宽高
      let { clientHeight: windowHeight, clientWidth: windowWidth } =
      ...
      // 计算后坐标  设置 按钮位置
          actionMgrStyle.left = event.clientX;
          actionMgrStyle.top =event.clientY;
